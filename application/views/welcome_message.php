...
<div class="row">
  	<div class="col-lg-12 margin-tb">
  	  <div class="pull-left">
  	    <h2>Projeto PHP usando Codeigniter 3</h2>
  	  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form data-toggle="validator" action="" method="put">
                ...
                <div class="form-group">
                    <label class="control-label" for="title">Titulo:</label>
                    <input type="text" name="title" class="form-control" data-error="Por favor insira o título." required />
                    <div class="help-block with-errors"></div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label" for="title">Descrição:</label>
                    <textarea name="description" class="form-control" data-error="Por favor insira a descrição." required></textarea>
                    <div class="help-block with-errors"></div>
                </div>
